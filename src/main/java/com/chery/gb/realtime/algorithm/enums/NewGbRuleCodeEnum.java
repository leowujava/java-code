...
public enum NewGbRuleCodeEnum {
    ...
    private static Map<String, SignalEnum> ruleSignalRelationMap = new HashMap<>();
    ...
    public static Map<String, SignalEnum> getRuleSignalRelationMap() {
        initSignalMap();
        return ruleSignalRelationMap;
    }
    ...
    private static void initSignalMap() {
        ...
        Map<String, Object> map = YmlReaderUtil.readConfig("./config/rulecode_signal_relation_config.yml");
        if (map == null) {
            return;
        }
