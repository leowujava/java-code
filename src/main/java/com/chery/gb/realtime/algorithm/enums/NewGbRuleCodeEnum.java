...
public enum NewGbRuleCodeEnum {
    ...
    public static List<NewGbRuleCodeEnum> getBySort() {
        ...
        //前置状态检测
//        ruleCodeList.add(RULE_CODE_VEHICLE_STATE_IS_NULL);
        ruleCodeList.add(RULE_CODE_22);
        ruleCodeList.add(RULE_CODE_23);
        ruleCodeList.add(RULE_CODE_24);
        ruleCodeList.add(RULE_CODE_259);
        ruleCodeList.add(RULE_CODE_250);
        ruleCodeList.add(RULE_CODE_25);
        ruleCodeList.add(RULE_CODE_26);
        ruleCodeList.add(RULE_CODE_27);
        ruleCodeList.add(RULE_CODE_VEHICLE_CHARGING_STATE_CHECK);

        //基础项检测
        //燃料电池数据检测
        ruleCodeList.add(RULE_CODE_95);
        ruleCodeList.add(RULE_CODE_96);
        ruleCodeList.add(RULE_CODE_97);
        ruleCodeList.add(RULE_CODE_98);
        ruleCodeList.add(RULE_CODE_99);
        ruleCodeList.add(RULE_CODE_100);
        ruleCodeList.add(RULE_CODE_101);
        ruleCodeList.add(RULE_CODE_102);
        ruleCodeList.add(RULE_CODE_103);
        ruleCodeList.add(RULE_CODE_104);
        ruleCodeList.add(RULE_CODE_105);
        ruleCodeList.add(RULE_CODE_106);
        ruleCodeList.add(RULE_CODE_107);
        ruleCodeList.add(RULE_CODE_108);
        ruleCodeList.add(RULE_CODE_109);
        ruleCodeList.add(RULE_CODE_110);
        ruleCodeList.add(RULE_CODE_111);
        ruleCodeList.add(RULE_CODE_112);
        ruleCodeList.add(RULE_CODE_113);
        ruleCodeList.add(RULE_CODE_114);
        ruleCodeList.add(RULE_CODE_115);
        ruleCodeList.add(RULE_CODE_116);
        ruleCodeList.add(RULE_CODE_117);
        ruleCodeList.add(RULE_CODE_118);
        ruleCodeList.add(RULE_CODE_119);
        ruleCodeList.add(RULE_CODE_120);
        ruleCodeList.add(RULE_CODE_121);
        ruleCodeList.add(RULE_CODE_122);
        ruleCodeList.add(RULE_CODE_123);
        ruleCodeList.add(RULE_CODE_124);
        ruleCodeList.add(RULE_CODE_125);
        ruleCodeList.add(RULE_CODE_126);
        ruleCodeList.add(RULE_CODE_127);
        ruleCodeList.add(RULE_CODE_128);
        ruleCodeList.add(RULE_CODE_129);
        ruleCodeList.add(RULE_CODE_130);
        ruleCodeList.add(RULE_CODE_131);
        ruleCodeList.add(RULE_CODE_132);
        ruleCodeList.add(RULE_CODE_133);
        ruleCodeList.add(RULE_CODE_134);
        ruleCodeList.add(RULE_CODE_135);
        ruleCodeList.add(RULE_CODE_136);
        ruleCodeList.add(RULE_CODE_137);
        ruleCodeList.add(RULE_CODE_138);
        ruleCodeList.add(RULE_CODE_139);
        ruleCodeList.add(RULE_CODE_140);
        ruleCodeList.add(RULE_CODE_141);
        ruleCodeList.add(RULE_CODE_142);
        ruleCodeList.add(RULE_CODE_143);
        ruleCodeList.add(RULE_CODE_144);
        ruleCodeList.add(RULE_CODE_145);
        ruleCodeList.add(RULE_CODE_146);
        ruleCodeList.add(RULE_CODE_147);
        ruleCodeList.add(RULE_CODE_243);
        ruleCodeList.add(RULE_CODE_244);

        //超级电容数据检测
        ruleCodeList.add(RULE_CODE_184);
        ruleCodeList.add(RULE_CODE_185);
        ruleCodeList.add(RULE_CODE_186);
        ruleCodeList.add(RULE_CODE_187);
        ruleCodeList.add(RULE_CODE_188);
        ruleCodeList.add(RULE_CODE_189);
        ruleCodeList.add(RULE_CODE_190);
        ruleCodeList.add(RULE_CODE_191);
        ruleCodeList.add(RULE_CODE_192);
        ruleCodeList.add(RULE_CODE_193);
        ruleCodeList.add(RULE_CODE_194);
        ruleCodeList.add(RULE_CODE_195);
        ruleCodeList.add(RULE_CODE_196);
        ruleCodeList.add(RULE_CODE_197);
        ruleCodeList.add(RULE_CODE_198);
        ruleCodeList.add(RULE_CODE_199);
        ruleCodeList.add(RULE_CODE_200);
        ruleCodeList.add(RULE_CODE_201);
        ruleCodeList.add(RULE_CODE_202);
        ruleCodeList.add(RULE_CODE_203);
        ruleCodeList.add(RULE_CODE_204);
        ruleCodeList.add(RULE_CODE_205);
        ruleCodeList.add(RULE_CODE_206);
        ruleCodeList.add(RULE_CODE_207);
        ruleCodeList.add(RULE_CODE_208);
        ruleCodeList.add(RULE_CODE_209);
        ruleCodeList.add(RULE_CODE_210);
        ruleCodeList.add(RULE_CODE_211);
        ruleCodeList.add(RULE_CODE_212);
        ruleCodeList.add(RULE_CODE_213);
        ruleCodeList.add(RULE_CODE_214);
        ruleCodeList.add(RULE_CODE_215);
        ruleCodeList.add(RULE_CODE_216);
        ruleCodeList.add(RULE_CODE_217);
        ruleCodeList.add(RULE_CODE_218);
        ruleCodeList.add(RULE_CODE_219);
        ruleCodeList.add(RULE_CODE_220);
        ruleCodeList.add(RULE_CODE_221);
        ruleCodeList.add(RULE_CODE_222);
        ruleCodeList.add(RULE_CODE_223);
        ruleCodeList.add(RULE_CODE_224);
        ruleCodeList.add(RULE_CODE_225);
        ruleCodeList.add(RULE_CODE_226);
        ruleCodeList.add(RULE_CODE_227);
        ruleCodeList.add(RULE_CODE_228);
        ruleCodeList.add(RULE_CODE_229);
        ruleCodeList.add(RULE_CODE_230);
        ruleCodeList.add(RULE_CODE_231);
        ruleCodeList.add(RULE_CODE_232);
        ruleCodeList.add(RULE_CODE_233);
        ruleCodeList.add(RULE_CODE_234);
        ruleCodeList.add(RULE_CODE_235);
        ruleCodeList.add(RULE_CODE_236);
        ruleCodeList.add(RULE_CODE_237);
        ruleCodeList.add(RULE_CODE_238);
        ruleCodeList.add(RULE_CODE_247);
        ruleCodeList.add(RULE_CODE_248);

        ruleCodeList.add(RULE_CODE_269);

        ruleCodeList.add(RULE_CODE_162);
        ruleCodeList.add(RULE_CODE_163);

        ruleCodeList.add(RULE_CODE_54);

        ruleCodeList.add(RULE_CODE_70);

        ruleCodeList.add(RULE_CODE_256);

        ruleCodeList.add(RULE_CODE_167);
        ruleCodeList.add(RULE_CODE_171);
        ruleCodeList.add(RULE_CODE_175);
        ruleCodeList.add(RULE_CODE_179);
        ruleCodeList.add(RULE_CODE_183);

        ruleCodeList.add(RULE_CODE_37);
        ruleCodeList.add(RULE_CODE_38);
        ruleCodeList.add(RULE_CODE_39);
        ruleCodeList.add(RULE_CODE_40);
        ruleCodeList.add(RULE_CODE_41);
        ruleCodeList.add(RULE_CODE_42);
        ruleCodeList.add(RULE_CODE_43);
        ruleCodeList.add(RULE_CODE_44);
        ruleCodeList.add(RULE_CODE_45);
        ruleCodeList.add(RULE_CODE_46);
        ruleCodeList.add(RULE_CODE_47);
        ruleCodeList.add(RULE_CODE_48);
        ruleCodeList.add(RULE_CODE_50);
        ruleCodeList.add(RULE_CODE_51);
        ruleCodeList.add(RULE_CODE_52);
        ruleCodeList.add(RULE_CODE_53);
        ruleCodeList.add(RULE_CODE_55);
        ruleCodeList.add(RULE_CODE_56);
        ruleCodeList.add(RULE_CODE_57);
        ruleCodeList.add(RULE_CODE_58);
        ruleCodeList.add(RULE_CODE_59);
        ruleCodeList.add(RULE_CODE_60);
        ruleCodeList.add(RULE_CODE_61);
        ruleCodeList.add(RULE_CODE_62);
        ruleCodeList.add(RULE_CODE_63);
        ruleCodeList.add(RULE_CODE_64);
        ruleCodeList.add(RULE_CODE_65);
        ruleCodeList.add(RULE_CODE_66);
        ruleCodeList.add(RULE_CODE_67);
        ruleCodeList.add(RULE_CODE_68);
        ruleCodeList.add(RULE_CODE_69);
        ruleCodeList.add(RULE_CODE_71);
        ruleCodeList.add(RULE_CODE_72);
        ruleCodeList.add(RULE_CODE_73);
        ruleCodeList.add(RULE_CODE_74);
        ruleCodeList.add(RULE_CODE_75);
        ruleCodeList.add(RULE_CODE_76);
        ruleCodeList.add(RULE_CODE_151);
        ruleCodeList.add(RULE_CODE_154);
        ruleCodeList.add(RULE_CODE_155);
        ruleCodeList.add(RULE_CODE_159);
        ruleCodeList.add(RULE_CODE_160);
        ruleCodeList.add(RULE_CODE_161);
        ruleCodeList.add(RULE_CODE_164);
        ruleCodeList.add(RULE_CODE_165);
        ruleCodeList.add(RULE_CODE_166);
        ruleCodeList.add(RULE_CODE_168);
        ruleCodeList.add(RULE_CODE_169);
        ruleCodeList.add(RULE_CODE_170);
        ruleCodeList.add(RULE_CODE_172);
        ruleCodeList.add(RULE_CODE_173);
        ruleCodeList.add(RULE_CODE_174);
        ruleCodeList.add(RULE_CODE_176);
        ruleCodeList.add(RULE_CODE_177);
        ruleCodeList.add(RULE_CODE_178);
        ruleCodeList.add(RULE_CODE_180);
        ruleCodeList.add(RULE_CODE_181);
        ruleCodeList.add(RULE_CODE_182);
        ruleCodeList.add(RULE_CODE_251);
        ruleCodeList.add(RULE_CODE_252);
        ruleCodeList.add(RULE_CODE_253);


        ruleCodeList.add(RULE_CODE_31);
        ruleCodeList.add(RULE_CODE_32);
        ruleCodeList.add(RULE_CODE_34);
        ruleCodeList.add(RULE_CODE_35);


        ruleCodeList.add(RULE_CODE_33);
        ruleCodeList.add(RULE_CODE_36);


        ruleCodeList.add(RULE_CODE_49);
        ruleCodeList.add(RULE_CODE_254);

        //运行模式-前置
        ruleCodeList.add(RULE_CODE_RUNNING_MODE_IS_NULL);
        ruleCodeList.add(RULE_CODE_28);
        ruleCodeList.add(RULE_CODE_29);
        ruleCodeList.add(RULE_CODE_30);

        //运行模式-1
        ruleCodeList.add(RULE_CODE_255);
        ruleCodeList.add(RULE_CODE_257);

        //运行模式-1、2
        ruleCodeList.add(RULE_CODE_77);
        ruleCodeList.add(RULE_CODE_78);
        ruleCodeList.add(RULE_CODE_79);
        ruleCodeList.add(RULE_CODE_80);
        ruleCodeList.add(RULE_CODE_81);
        ruleCodeList.add(RULE_CODE_82);
        ruleCodeList.add(RULE_CODE_83);
        ruleCodeList.add(RULE_CODE_84);
        ruleCodeList.add(RULE_CODE_85);
        ruleCodeList.add(RULE_CODE_86);
        ruleCodeList.add(RULE_CODE_87);
        ruleCodeList.add(RULE_CODE_88);
        ruleCodeList.add(RULE_CODE_89);
        ruleCodeList.add(RULE_CODE_90);
        ruleCodeList.add(RULE_CODE_91);
        ruleCodeList.add(RULE_CODE_92);
        ruleCodeList.add(RULE_CODE_93);
        ruleCodeList.add(RULE_CODE_94);

        //运行模式-2、3
        ruleCodeList.add(RULE_CODE_148);
        ruleCodeList.add(RULE_CODE_149);
        ruleCodeList.add(RULE_CODE_150);

        ruleCodeList.add(RULE_CODE_1);
        ruleCodeList.add(RULE_CODE_2);
        ruleCodeList.add(RULE_CODE_3);
        ruleCodeList.add(RULE_CODE_4);
        ruleCodeList.add(RULE_CODE_5);
        ruleCodeList.add(RULE_CODE_6);
        ruleCodeList.add(RULE_CODE_7);
        ruleCodeList.add(RULE_CODE_8);
        ruleCodeList.add(RULE_CODE_9);
        ruleCodeList.add(RULE_CODE_10);
        ruleCodeList.add(RULE_CODE_11);
        ruleCodeList.add(RULE_CODE_12);
        ruleCodeList.add(RULE_CODE_13);
        ruleCodeList.add(RULE_CODE_14);
        ruleCodeList.add(RULE_CODE_15);
        ruleCodeList.add(RULE_CODE_16);
        ruleCodeList.add(RULE_CODE_17);
        ruleCodeList.add(RULE_CODE_18);
        ruleCodeList.add(RULE_CODE_19);
        ruleCodeList.add(RULE_CODE_20);
        ruleCodeList.add(RULE_CODE_21);
        ruleCodeList.add(RULE_CODE_152);
        ruleCodeList.add(RULE_CODE_153);
        ruleCodeList.add(RULE_CODE_156);
        ruleCodeList.add(RULE_CODE_157);
        ruleCodeList.add(RULE_CODE_158);
        ruleCodeList.add(RULE_CODE_260);
        ruleCodeList.add(RULE_CODE_261);
        ruleCodeList.add(RULE_CODE_262);
        ruleCodeList.add(RULE_CODE_263);
        ruleCodeList.add(RULE_CODE_264);
        ruleCodeList.add(RULE_CODE_265);
        ruleCodeList.add(RULE_CODE_266);
        ruleCodeList.add(RULE_CODE_267);
        ruleCodeList.add(RULE_CODE_268);
        ruleCodeList.add(RULE_CODE_270);
        ruleCodeList.add(RULE_CODE_271);
        ruleCodeList.add(RULE_CODE_273);
        ruleCodeList.add(RULE_CODE_274);
        ruleCodeList.add(RULE_CODE_275);
        return ruleCodeList;
    }
