 ...
 *
 */
@RuleValidate(rule = NewGbRuleCodeEnum.RULE_CODE_245)
public class RuleValidate_245 extends BaseRuleValidate {
    @Override
    public void validate(Map<String, Object> signalMap, Map<String, Map<String, List<RuleDetailBO>>> ruleMap, JSONArray retData) {
        ...
        boolean flag = checkNullByGroup(signalMap, SignalGroupEnum.ENGINE);;
