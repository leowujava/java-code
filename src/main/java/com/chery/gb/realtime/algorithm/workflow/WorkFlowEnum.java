...
public enum WorkFlowEnum {
    ...
    WF_3_1("3_1", "燃料电池汽车检测", "燃料电池数据检测", false, 0, WF_3),
    WF_3_2("3_2", "超级电容器汽车检测", "超级电容数据检测", false, 0, WF_3),
    ...
    WF_3_8_1("3_8_1", "故障数据为空检测", "故障数据关联逻辑检测", false, 2, WF_3_8),
    ...
    WF_4_1_1("4_1_1", "车速校验无效、异常、越界", "车速校验是否无效、异常、越界", false, 0, WF_4_1),
    WF_4_2("4_2", "里程校验控制", "里程校验是否为空", false, 0, WF_4),
    ...
    WF_6_3("6_3", "运行模式范围检测", "运行模式范围检测", false, 0, WF_6),
