 ...
 *
 */
@WorkFlowConfig(GbWorkFlowEnum.WF_6_1)
public class WorkFlowConfig_6_1 extends BaseWorkFlowConfig {
    public WorkFlowConfig_6_1() {
        ...
        list.add(RuleDetailBO.builder().signalId(SignalEnum.SIGNAL_21AB.getCode()).signalRule(RuleSymbolEnum.EQ.name()).detailRelation(RuleRelationEnum.AND.name()).build());
