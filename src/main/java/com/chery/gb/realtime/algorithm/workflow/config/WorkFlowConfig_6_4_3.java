 ...
 *
 */
@WorkFlowConfig(GbWorkFlowEnum.WF_6_4_3)
public class WorkFlowConfig_6_4_3 extends BaseWorkFlowConfig {
    public WorkFlowConfig_6_4_3() {
        RuleConditionBO condition = new RuleConditionBO();
        ArrayList<RuleDetailBO> conditions = new ArrayList<>();
        conditions.add(RuleDetailBO.builder().signalId(SignalEnum.SIGNAL_21AB.getCode()).signalRule(RuleSymbolEnum.EQ.name()).signalValue("3").build());
